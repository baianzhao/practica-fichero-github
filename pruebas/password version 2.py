...
#n1
    if not n1.isnumeric()==True or not int(n1)<=5 or int(n1)>=1:
        num_err=num_err +1#si no es, directamente error.
        merror=merror+'/Error en el caracter 1/'
        
#n2
    if not n2.isalpha()==True and not n2.islower()==True:
        num_err=num_err +1#si no es, directamente error.
        merror=merror+'/Error en el caracter 2/'

#n3
    if not n3.isalpha()==True and n3.islower()==True:
        num_err=num_err +1#si no es, directamente error.
...
#n5
    if not n5.isalpha()==True and not n5.islower()==True:
        num_err=num_err +1#si no es, directamente error.
